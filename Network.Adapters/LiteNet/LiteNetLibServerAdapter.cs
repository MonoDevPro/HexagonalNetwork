...
using DisconnectReason = Network.Core.Domain.Enums.DisconnectReason;
...
namespace Network.Adapters.LiteNet
{
    ...
    public class LiteNetLibServerAdapter : IServerNetworkService
    {
        ...
        /// </summary>
        private DisconnectReason MapDisconnectReasonToDomain(LiteNetLib.DisconnectReason reason)
        {
            return reason switch
            {
                ...
                LiteNetLib.DisconnectReason.DisconnectPeerCalled => DisconnectReason.ConnectionClosed,
