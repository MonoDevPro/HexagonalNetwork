...
public class DummyPacket : IPacket, INetworkSerializable
{
    ...
    public void Serialize(INetworkWriter writer) => writer.Write(Value);
...
public class CoreTests
{
    ...
    public void PacketRegistry_RegistersAndCreatesPacket()
    {
        ...
        registry.Setup(r => r.Register<DummyPacket>((s) => new DummyPacket()));
        registry.Object.Register<DummyPacket>((s) => new DummyPacket());
        registry.Verify(r => r.Register<DummyPacket>((s) => new DummyPacket()), Times.Once);
    }
